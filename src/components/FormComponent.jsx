...
const FormComponent = ({ collapsed, onAnalyze }) => {
    ...
    const performDataAnalysis = (data,meta) => {
        ...
        const { metaCount, totalItems, items, missingItemCount, totalMissingItemCount, totalInvalidItemCount, invalidItemCount, totalItemCompletenessRatio, totalItemValidityRatio, totalQualityRatio, completenessRatio: itemCompletenessRatio, validityRatio: itemValidityRatio, qualityRatio, invalidItems } = analyzeItems(data,meta);
